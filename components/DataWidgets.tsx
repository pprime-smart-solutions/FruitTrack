        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white p-5 rounded-2xl shadow-[0_2px_15px_rgba(0,0,0,0.02)] border border-slate-100 flex flex-col justify-between group hover:border-amber-200 transition-colors">
                <div className="flex justify-between items-start mb-2">
                    <div className="flex flex-col overflow-hidden">
                        <span className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1 truncate">Météo (Souss)</span>
                        <div className="flex items-center gap-2 my-2">
                            <CloudSun size={20} className="text-amber-500" />
                            <span className="text-xl font-bold text-slate-800">24°C</span>
                        </div>
                    </div>
                ...
                {/* 
                <div className="flex flex-col justify-between gap-2 mb-3 font-medium text-slate-500">
                    <span>H: 65%</span>
                    <span>V: 12 km/h</span>
                    <span>UV: 6</span>
                </div> */}
            ...
            <div className="bg-white p-5 rounded-2xl shadow-[0_2px_15px_rgba(0,0,0,0.02)] border border-slate-100 flex flex-col justify-between group hover:border-sage-200 transition-colors">
                <div className="flex justify-between items-start mb-4">
                    <div className="flex flex-col overflow-hidden">
                        <span className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1 truncate">Cours Export (Dhs/Kg)</span>
                        <div className="flex items-center gap-2 my-2">
                            <TrendingUp size={20} className="text-sage-600" />
                            <span className="text-xl font-bold text-slate-800">13.90 <span className="text-sm">Dhs</span></span>
                        </div>
                    </div>
            ...
            <div className="bg-white p-5 rounded-2xl shadow-[0_2px_15px_rgba(0,0,0,0.02)] border border-slate-100 flex flex-col justify-between group hover:border-cyan-200 transition-colors">
                <div className="flex justify-between items-start mb-2">
                    <div className="flex flex-col overflow-hidden">
                        <span className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1 truncate">Irrigation (Secteur 4)</span>
                        <div className="flex items-center gap-2 my-2">
                ...
                <div className="space-y-3 mt-2">
                    <div>
                        <div className="flex justify-between text-xs mb-1 font-medium overflow-hidden">
                            <span className="text-slate-500 flex items-center gap-1 truncate"><Sprout size={10} /> Besoins Sol</span>
                        </div>
                        <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
                            <div className="bg-cyan-500 h-1.5 rounded-full w-[98%]"></div>
                        </div>
                        <span className="text-slate-800 text-xs flex justify-end">Satisfait</span>
                    </div>
                    <div>
                        <div className="flex justify-between text-xs mb-1 font-medium overflow-hidden">
                            <span className="text-slate-500 flex items-center gap-1 truncate"><Sprout size={10} /> Volume Réservoir</span>
                        </div>
                        <div className="w-full bg-slate-100 rounded-full h-1.5 overflow-hidden">
                            <div className="bg-cyan-400 h-1.5 rounded-full w-[65%]"></div>
                        </div>
                        <span className="text-slate-800 text-xs flex justify-end">840 m³</span>
                    </div>
                </div>
            </div>
